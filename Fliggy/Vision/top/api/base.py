...
SYSTEM_GENERATE_VERSION = "taobao-sdk-python-20190912"
...
class RestApi(object):
    ...
    def getResponse(self, authrize=None, timeout=30):
        ...
        if(self.__port == 443):
            ...
            # 阿里sdk是python2, 所用环境为python3, 此处经过调整
        ...
        if(self.getMultipartParas()):
            ...
            # body = urllib.urlencode(application_parameter) # python2 版本
            # 经过调整
            body = urllib.parse.urlencode(application_parameter)

        # url = N_REST + "?" + urllib.urlencode(sys_parameters) # python2 版本
        # 经过调整
        ...
        # if jsonobj.has_key("error_response"): # python2 版本
